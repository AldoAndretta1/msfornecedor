package br.com.rd.msfornecedor.configuration;
...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.tags(new Tag("Mscliente", "Description of Mscliente"))
				.apiInfo(apiInfo());

	}

	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Mscliente API Rest")
				.description("Documentação da API Mscliente")
				.version("1.0")
